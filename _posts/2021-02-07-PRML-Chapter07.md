...
$$\frac{1}{2} \left\| \textbf{w} \right\|^2_2 = \frac{1}{2}\textbf{w}^T\textbf{w} \\ = \frac{1}{2}\textbf{w}^T \sum_{n=1}a_n t_n \phi(\textbf{x}_n) \\ = \frac{1}{2} \sum_{n=1}a_n t_n \textbf{w}^T \phi(\textbf{x}_n) \\ =  \frac{1}{2} \sum_{n=1}a_n t_n\sum_{m=1}a_m t_m \phi(\textbf{x}_m)^T \phi(\textbf{x}_n) \\ =\frac{1}{2} \sum_{n=1}\sum_{m=1}a_n t_na_m t_m \phi(\textbf{x}_m)^T \phi(\textbf{x}_n) \\ $$

두번째 항

$$- \sum_{n=1}^{N}{a_n\{ t_n(\textbf{w}^T \phi(\textbf{x}_n)+b)-1 \}} \\ = -\sum_{n=1}a_n t_n \textbf{w}^T \phi(\textbf{x}_n) - b\sum_{n=1} a_n t_n + \sum_{n=1}a_n \\ = -\sum_{n=1}\sum_{m=1}a_n a_m t_n t_m \phi(\textbf{x}_m)^T \phi(\textbf{x}_n) + \sum_{n=1}a_n$$
...
$$L(\textbf{w},b,\textbf{a}, \xi, \gamma)\\ = \frac{1}{2} \left\| \textbf{w} \right\|^2_2 + C\sum_{n=1}\xi_n  - \sum_{n=1}{a_n\{ t_n(\textbf{w}^T \phi(\textbf{x}_n)+b) - 1 + \xi_n \}} - \sum_{n=1}\gamma_n \xi_n$$
