...
mathjax : true
date: 2021-02-25
title: "[PRML] Chapter9 - Graphical Models"
---
...
<center><img src="../img/chap08-1.jpg" width="80%"></center>
...
$$p(\textbf{x}_1, \textbf{x}_2 | {\pmb \mu}) = \prod_{k=1}^{K} \prod_{l=1}^{K} \mu_{kl}^{x_{1k} x_{2l}}$$
...
$$p(\textbf{x}) = \frac{1}{Z} \prod_C \psi_C(\textbf{x}_C)\\Z=\sum_{\textbf{x}} \prod_C \psi_C (\textbf{x}_C)$$
