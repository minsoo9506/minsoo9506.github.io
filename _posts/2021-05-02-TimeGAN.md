...
$$\mathcal{Z_{S}}\times\prod_{t}\mathcal{Z_{X}}\rightarrow\mathcal{H_{S}\times\prod}_{t}\mathcal{H_{X}}$$
...
$$\overrightarrow{\boldsymbol{u}}_{t}=\overrightarrow{c}_{\mathcal{X}}(\tilde{\boldsymbol{h}}_{\mathcal{S}},\tilde{\boldsymbol{h}}_{t},\overrightarrow{\boldsymbol{u}}_{t-1}),\;\overleftarrow{\boldsymbol{u}}_{t}=\overleftarrow{c}_{\mathcal{X}}(\tilde{\boldsymbol{h}}_{\mathcal{S}},\tilde{\boldsymbol{h}}_{t},\overleftarrow{\boldsymbol{u}}_{t+1}))$$
